	...
	public void run() {
		...
		try {
			...
			while(true) {
				...
				//Reenvio de datos al otro cliente

				//Creamos la comunicacion
				Socket sockResend = new Socket(ip, 9090);

				//Creamos el flujo de datos de reenvio
				ObjectOutputStream outputStream = new ObjectOutputStream(sockResend.getOutputStream());
				outputStream.writeObject(datosInput);
